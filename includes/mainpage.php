...
include_once "/var/www/html/kgwpt/wp-content/plugins/c_form/includes/redirect.php";
include_once "/var/www/html/kgwpt/wp-content/plugins/c_form/includes/formlib.php";
...
class MainPage {
	...
	protected $cookie_key; //!< cookie with email address
	protected $secret;     //!< secret for recaptcha
	protected $sendGRID;   //!< secret for SendGrid email
     ...
     */
    function __construct($db = "", $sessnp="no", $checkArray="", $secret="", $sendGridAPIKey="") {
	$this->db = $db ;
	$this->sessnp = $sessnp;
	$this->secret = $secret;
	$this->sendGRID = $sendGridAPIKey;
